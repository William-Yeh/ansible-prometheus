...
DAEMON={{ prometheus_mysqld_exporter_daemon_dir }}/mysqld_exporter
...
DAEMON_OPTS='{{ prometheus_mysqld_exporter_opts }}'
{% else %}
DAEMON_OPTS=
{% endif %}
...
case "$1" in
  ...
  reload)
    ...
    #-- sorry but mysqld_exporter doesn't handle -HUP signal...
